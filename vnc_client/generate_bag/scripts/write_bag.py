...
from generate_bag.msg import DriveInfo
from generate_bag.msg import Odom
from std_msgs.msg import Header
from visualization_msgs.msg import MarkersArray, Marker
...
def write_bag_file(name, drive_data, odom_data):
    ...
    try:
        ...
        for odom_entry in odom_data:
                ...
                marker.pose.position.x = odom_entry["odom.pose.pose.position.x"]
                marker.pose.position.y = odom_entry["odom.pose.pose.position.y"]
                marker.pose.position.z = odom_entry["odom.pose.pose.position.z"]

                MarkersArray_msg.markers.append(marker)
    ...
    markerBag = rosbag.Bag('~/markers.bag', 'w')

    markerBag.write('MarkersArray', MarkersArray_msg)
    markerBag.close()  
